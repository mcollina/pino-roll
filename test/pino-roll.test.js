...
it('remove pre-existing log files when removing files based on count when limit.removeOtherLogFiles', { skip: process.platform === 'win32' }, async () => {
  ...
  // Wait for cleanup to complete after stream is closed

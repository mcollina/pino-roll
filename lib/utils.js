...
function getNext (frequency, tz = undefined) {
  if (frequency === 'daily') {
    return getNextDay(new Date().setHours(0, 0, 0, 0), tz)
  }
  if (frequency === 'hourly') {
    return getNextHour(new Date().setMinutes(0, 0, 0), tz)
  }
  if (frequency === 'weekly') {
    return getNextWeek(undefined, tz)
  }
